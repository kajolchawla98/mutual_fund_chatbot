...
4. User Interface 
user interface should look similar to groww UI with same theme it should have a button chat with us
bit animation should be there when user opens the chatbot
it should also show previous conversations user has had 
The solution should include a user friendly interface with:
A welcome message How can I help you today ?
